class CreateCommentHierarchies < ActiveRecord::Migration[5.0]
  def change
    create_table :comment_hierarchies, id: false do |t|
      t.string  :ancestor_id, null: false   # ID of the parent/grandparent/great-grandparent/... comments
      t.string  :descendant_id, null: false # ID of the target comment
      t.string  :generations, null: false   # Number of generations between the ancestor and the descendant. Parent/child = 1, for example.
    end
